...
layout:     post
title:      快速搭建个人博客
subtitle:   利用Jekyll与Github Pages搭建的个人博客(这篇文章我是照搬我女朋友博客的，希望她别打我😂)
date:       2019-08-18
author:     YY
...
>
> 在这里我十分感谢[女朋友大人](https://gg-lige.github.io)给我提的建议，并且希望她原谅我照搬了她的内容（跑）。
> 
> [我的的博客](http://yiyang-wang.github.io)

# 前言
从 Jekyll 到 GitHub Pages 按照BY的搭建过程进行，终于把我的个人博客[YY Blog](https://yiyang-wang.github.io/)搭建出来了。
以下为[BY博客](https://github.com/qiubaiying)内容。
...
首先你先注册一个百度账号，这个应该人人都有了吧，然后在[Baidu Analytics](http://tongji.baidu.com/web/welcome/login)中登录，然后按照下面图片所示添加你的博客地址，再在head.html中添加script块，即可完成代码的安装。

![](https://note.youdao.com/yws/api/personal/file/EDCE21A286C741FDA881E57628EB18A4?method=download&shareKey=afc972b30597225d2ae8fc856194c905)

![](https://note.youdao.com/yws/api/personal/file/9C26B9C26C1344DDAB5B5B179ADB9F2F?method=download&shareKey=5820b49fa1a44f4990c50b4c25d39ad9)
